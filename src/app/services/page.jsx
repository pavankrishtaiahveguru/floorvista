...
export default function ServicesPage() {
  return (
    <main className="min-h-screen bg-[#F7F6F1] text-[#173B38]">
      ...
      <section className="bg-[#173B38] px-6 py-20 text-white sm:px-8 lg:px-12 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-12">
            ...
            >
              ...
              <h2 className="text-4xl font-light leading-tight tracking-tight sm:text-5xl lg:text-6xl">
                Design that
                <br />
                <span className="italic">makes sense.</span>
              </h2>
            </motion.div>
                ...
                {[
                  {
                    number: "01",
                    title: "Understand",
                    text: "We begin by understanding your vision, requirements, site, and possibilities.",
                  },
                  {
                    number: "02",
                    title: "Design",
                    text: "We translate ideas into thoughtful architectural and design solutions.",
                  },
                  {
                    number: "03",
                    title: "Refine",
                    text: "Every detail is carefully considered to balance beauty, function, and practicality.",
                  },
                  {
                    number: "04",
                    title: "Deliver",
                    text: "We help transform the final design into a space built around your vision.",
                  },
                ].map((step, index) => (
                  <motion.div
                    key={step.number}
                    ...
                    className="grid grid-cols-[60px_1fr] gap-5 py-7"
                  >
