...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[#FFFDF9] text-[#173B38]">
      ...
      {/* Services */}
      <section className="bg-[#F1F3EF] px-6 py-20 sm:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            >
              <p className="mb-5 text-xs font-medium uppercase tracking-[0.25em] text-[#173B38]/45">
                What We Do
              </p>
              ...
              <h2 className="text-4xl font-light leading-tight tracking-tight sm:text-5xl">
                One vision.
                <br />
                <span className="italic">Multiple disciplines.</span>
              </h2>
            </motion.div>
            ...
            <div className="grid sm:grid-cols-2">
              {services.map((service, index) => (
                <motion.div
                  ...
                  className="border-t border-[#173B38]/15 px-1 py-7 sm:px-6"
                >
                  <span className="text-xs text-[#173B38]/40">
                    0{index + 1}
                  </span>

                  <h3 className="mt-4 text-xl font-light text-[#173B38]">
                    {service}
                  </h3>
                </motion.div>
              ))}
          ...
          <motion.div
            ...
            className="mt-14 border-t border-[#173B38]/15 pt-8"
          >
            <p className="max-w-3xl text-base leading-8 text-[#173B38]/65">
      ...
      <section className="px-6 py-20 sm:px-8 lg:px-12 lg:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="mt-7 text-base leading-8 text-[#173B38]/65">
              We believe good design is more than appearance. It should respond
              to the way people live, work, move, and experience a space. Our
              approach combines creativity with practical thinking to deliver
              spaces that are beautiful, efficient, and enduring.
            </p>
          </motion.div>

          {/* Values */}
          <div className="mt-14 grid border-t border-[#173B38]/15 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((value, index) => (
              <motion.div
                ...
                className="border-b border-[#173B38]/15 px-1 py-7 sm:border-r sm:px-6 lg:border-b-0"
              >
                <div className="flex h-9 w-9 items-center justify-center rounded-full border border-[#173B38]/20">
                  <Check size={15} strokeWidth={1.5} />
                </div>

                <p className="mt-5 text-sm leading-6 text-[#173B38]/70">
                  {value}
                </p>
              </motion.div>
            ))}
